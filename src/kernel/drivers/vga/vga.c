...
static unsigned short vga_entry (unsigned char ch, unsigned char f_color,
                                 unsigned char b_color);
static void vga_buffer_clear (unsigned short **vga_buffer,
                              unsigned char f_color, unsigned char b_color);
...
vga_entry (unsigned char ch, unsigned char f_color, unsigned char b_color)
{
  unsigned short ax = 0;
...
static void
vga_buffer_clear (unsigned short **vga_buffer, unsigned char f_color,
                  unsigned char b_color)
{
  unsigned int i;
...
void
vga_init (unsigned char f_color, unsigned char b_color)
{
...
void
vga_print_newline (unsigned char f_color, unsigned char b_color)
{
  if (g_vga_row >= 55)
    {
      vga_buffer_clear (&g_vga_buffer, f_color, b_color);
...
void
vga_print_char (char ch, unsigned char f_color, unsigned char b_color)
{
...
void
vga_print_string (char *str, unsigned char f_color, unsigned char b_color)
{
  unsigned int i = 0;
  while (str[i])
    {
